export default function Location() {
  return (
    <section id="ubicacion" style={{ background: '#0A0A0A', padding: '100px 24px', borderTop: '1px solid rgba(201,168,76,0.08)' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>

        {/* Header */}
        <div style={{ textAlign: 'center', marginBottom: '52px' }}>
          <p style={{ fontFamily: 'Raleway, sans-serif', color: '#C9A84C', fontSize: '0.68rem', letterSpacing: '0.45em', fontWeight: 600, marginBottom: '16px' }}>
            ✦ ENCUÉNTRANOS ✦
          </p>
          <h2 style={{ fontFamily: 'Playfair Display, serif', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', color: '#F5F0E8', fontWeight: 700, marginBottom: '20px' }}>
            Nuestra Ubicación
          </h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            {/* Address */}
            <div style={{ background: '#111', border: '1px solid rgba(201,168,76,0.15)', borderRadius: '12px', padding: '28px' }}>
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                <div style={{ width: '40px', height: '40px', background: 'rgba(201,168,76,0.1)', border: '1px solid rgba(201,168,76,0.3)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <span style={{ fontSize: '1.1rem' }}>📍</span>
                </div>
                <div>
                  <p style={{ fontFamily: 'Raleway, sans-serif', color: '#C9A84C', fontSize: '0.68rem', letterSpacing: '0.25em', fontWeight: 600, marginBottom: '6px' }}>DIRECCIÓN</p>
                  <p style={{ fontFamily: 'Raleway, sans-serif', color: '#F5F0E8', fontSize: '0.95rem', lineHeight: 1.7 }}>
                    2 Oriente 124<br />
            ...
            <div style={{ background: '#111', border: '1px solid rgba(201,168,76,0.15)', borderRadius: '12px', padding: '28px' }}>
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                ...
                <div style={{ width: '100%' }}>
                  <p style={{ fontFamily: 'Raleway, sans-serif', color: '#C9A84C', fontSize: '0.68rem', letterSpacing: '0.25em', fontWeight: 600, marginBottom: '10px' }}>HORARIOS</p>
                  {[
            ...
            {/* CTA button */}
            <a
              href="https://www.google.com/maps/place/2+Ote.+124,+2520784+Vi%C3%B1a+del+Mar,+Valpara%C3%ADso"
              target="_blank"
              rel="noreferrer"
              style={{
                display: 'flex',
